...
<div class="login-box">
	<div class="login-logo">
		<b>Admin Panel Intranet PT. Pusri Palembang</b>
	</div>
  	<div class="login-box-body">
    	<p class="login-box-msg">Silahkan Masukan ID dan Password Dengan Benar</p>
		...
		<form action="" method="post">
			<div class="form-group has-feedback">
				<input class="form-control" placeholder="ID" name="email" type="email" autocomplete="off" autofocus>
			</div>
			<div class="form-group has-feedback">
