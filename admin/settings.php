		...
		<div class="col-md-12">
				...
				<div class="nav-tabs-custom">
					<ul class="nav nav-tabs">
						...
						<li><a href="#tab_3" data-toggle="tab">Konten General</a></li>
						<li><a href="#tab_5" data-toggle="tab">Berita</a></li>
						<li><a href="#tab_6" data-toggle="tab">Beranda</a></li>
                        <li><a href="#tab_7" data-toggle="tab">Warna dasar</a></li>
					</ul>
					<div class="tab-content">
          				...
          				<div class="tab-pane" id="tab_3">
							...
							<div class="box box-info">
								<div class="box-body">
									<div class="form-group">
										<label for="" class="col-sm-2 control-label">Footer - Motto </label>
										<div class="col-sm-9">
          				...
          				<div class="tab-pane" id="tab_6">
                            ...
                            <h3>Website Karyawan Section</h3>
							<form class="form-horizontal" action="" method="post" enctype="multipart/form-data">
                            <div class="box box-info">
                                <div class="box-body">
	                                <div class="form-group">
