...
if(isset($_POST['form1'])) {
    ...
    if($valid == 1) {
    	...
    	$success_message = 'Download is added successfully.';
    }
}
?>
				...
				<div class="box box-info">
					<div class="box-body">
						<div class="form-group">
							<label for="" class="col-sm-2 control-label">Download Title <span>*</span></label>
							<div class="col-sm-9">
								<input type="text" class="form-control" name="faq_title">
							</div>
						</div>
						<div class="form-group">
							<label for="" class="col-sm-2 control-label">Download Content <span>*</span></label>
							<div class="col-sm-9">
								<textarea class="form-control" name="faq_content" id="editor1"></textarea>
							</div>
						</div>
						<div class="form-group">
							<label for="" class="col-sm-2 control-label">Select Download Category <span>*</span></label>
							<div class="col-sm-4">
								<select class="form-control select2" name="faq_category_id">
									<option value="">Select a Download category</option>
									<?php
